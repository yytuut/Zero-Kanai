  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        desc: "<h3>感想</h3>",
        extraContent: `
        <p>&nbsp;&nbsp;ゼロから始めたこのプロジェクトは、文字通りITの知識がゼロだったため、最初は多くの困難がありました。しかし、チームメンバーとプロジェクトを進める中で、多くのコミュニケーションを通じてお互いの不足している点を補い合い、克服することができました。これらの経験から、協力の重要性を改めて実感する機会になったと思います。それに加えて、これまで一度も使ったことのなかったJavaScriptを使うことができて、良い経験になったと思い、ITの知識を積む上でも役に立ちました。<br><br>
        &nbsp;&nbsp;残念だったことは日本語が苦手で、インタビューの際にうまく話せなかったことです。また、ビジネスメールを送るときにもビジネス日本語にまだ慣れておらず、チームメンバーに多く助けてもらった記憶があります。日本語の重要性を改めて実感し、もっと勉強しなければならないと反省しました。チームメンバーには本当に申し訳ない気持ちが強いプロジェクトだったと思います。まだ開発の経験がなく、Webページの機能をあまり実装できなかったのも心残りです。
        今回の経験を通じて、将来社会に出て会社でチームプロジェクトを行うときには、今とは違う自分になっていると思います。そのために、これからもっと成長できるように努力していきたいと思います。<br><br>
        &nbsp;&nbsp;今回のプロジェクトの機会をくださった先生方と金井さんに心より感謝申し上げます。また、夏休みの間、私のことをサポートして、一緒に頑張ってくれたチームメンバーにも感謝の気持ちを伝えたいです。
        </p>
        `,
      },
    ],
